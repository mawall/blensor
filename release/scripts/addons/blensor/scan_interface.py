...
def scan_rays(rays,
    ...
    if True:
        ...
        for idx in range(numberOfRays):
            if return_all or (max_distance > returns_buffer[idx * ELEMENTS_PER_RETURN] > 0.0):
                ...
                ret.append(names_buffer[idx * CHARS_PER_RETURN:idx * CHARS_PER_RETURN + CHARS_PER_RETURN])  # elem name
